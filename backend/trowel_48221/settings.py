"""
Django settings for trowel_48221 project.
...
ROOT_URLCONF = 'trowel_48221.urls'
...
WSGI_APPLICATION = 'trowel_48221.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "trowel_48221 API",
    "DESCRIPTION": "API documentation for trowel_48221 App",
    "VERSION": "v1",
}
